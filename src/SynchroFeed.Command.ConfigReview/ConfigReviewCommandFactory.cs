...
{
    /// <summary>
    /// The config review command scans a package's config to scan for any invalid configuration.
    /// </summary>
    public class ConfigReviewCommandFactory : BaseCommandFactory
    {
        /// <summary>
        ...
        public override string Type { get; } = "ConfigReview";
        ...
        public override ICommand Create(IAction action, Settings.Command commandSettings)
        {
            ...
            var command = ActivatorUtilities.CreateInstance<ConfigReviewCommand>(ServiceProvider, action,
