...
{
    public class NugetContainsSupportFilesCommandFactory : BaseCommandFactory
    {
        /// <summary>
        ...
        public override string Type { get; } = "NugetContainsSupportFiles";
        ...
        public override ICommand Create(IAction action, Settings.Command commandSettings)
        {
            ...
            var command = ActivatorUtilities.CreateInstance<NugetContainsSupportFilesCommand>(ServiceProvider, action,
